...
var TopicFlow = function (_React$Component) {
  ...
  function TopicFlow(props) {
    ...
    = _possibleConstructorReturn(this, (TopicFlow.__proto__ || Object.getPrototypeOf(TopicFlow)).call(this, props));
    ...
    _this.onLeave = _this._onLeave.bind(_this);_this.onBarClick = _this._onBarClick.bind(_this);
    _this.lineData = [];
    _this.barData = [];
    _this.topics = [];
    _this.barWidth = 0;
...
TopicFlow.propTypes = {
  ...
  numTData: _propTypes2.default.number.isRequired,
  ...
  timeBins: _propTypes2.default.array,
