    ...
    value: function initTopics(props) {
      ...
      var svgTopicBars = props.timeBins.map(function (dataArr, i) {
        ...
        dataArr.topics.map(function (data, index) {
          ...
          var cName = events[0].toString().split(/:|-/, 1) + '-' + i.toString();
          var barStyle = { stroke: _this2.prefScale(events[0].split(/:|-/, 1)[0]) };
    ...
    value: function renderTopics(props) {
      ...
      var cData = function cData(data, key) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_TextBar2.default, _extends({}, data.bar, { onEnter: _this3.onEnter, onLeave: _this3.onLeave, onClick: _this3.onClick })),
          lineInfo
        );
      };
      ...
      props.timeBins.map(function (data, index) {
        data.topics.map(function (d, i) {
          var nData = [];
          var key = 'bar-' + index + '-' + i;
          if (_this3.props.clickArray[d.events[0].toString().split(/:|-/, 1)]) {
            if (nData.sel) {
