...
var HybridScatterHeatmap = exports.HybridScatterHeatmap = function (_React$Component) {
  ...
  function HybridScatterHeatmap(props) {
    ...
    // Set default state
    var _this = _possibleConstructorReturn(this, (HybridScatterHeatmap.__proto__ || Object.getPrototypeOf(HybridScatterHeatmap)).call(this, props));
...
HybridScatterHeatmap.propTypes = {
  clsName: _propTypes2.default.string.isRequired,
  margin: _propTypes2.default.object,
  height: _propTypes2.default.number,
  xLabel: _propTypes2.default.string,
  yLabel: _propTypes2.default.string,
  scatterOnClick: _propTypes2.default.func,
  scatterOnMouseOver: _propTypes2.default.func,
  scatterOnMouseOut: _propTypes2.default.func,
  heatmapOnClick: _propTypes2.default.func,
  heatmapOnMouseOver: _propTypes2.default.func,
  heatmapOnMouseOut: _propTypes2.default.func,
  idAccessor: _propTypes2.default.string,
  xAccessor: _propTypes2.default.string.isRequired,
  yAccessor: _propTypes2.default.string.isRequired,
  minScatterColor: _propTypes2.default.any,
  maxScatterColor: _propTypes2.default.any,
  minHeatmapColor: _propTypes2.default.any,
  maxHeatmapColor: _propTypes2.default.any,
  numColorCat: _propTypes2.default.number,
  yDomain: _propTypes2.default.array.isRequired,
  data: _propTypes2.default.array,
  startTime: _propTypes2.default.number,
  timeWindow: _propTypes2.default.number,
  heatmapVertDivisions: _propTypes2.default.number,
  heatmapHorzDivisions: _propTypes2.default.number
