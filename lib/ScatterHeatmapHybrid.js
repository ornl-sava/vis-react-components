...
var HybridScatterHeatmap = exports.HybridScatterHeatmap = function (_React$Component) {
  ...
  _createClass(HybridScatterHeatmap, [{
    ...
    value: function createChart() {
      ...
      header.append('text').attr('class', 'label time').text('Displaying events from ' + _d2.default.time.format('%x %X')(new Date(this.endTime)) + ' to ' + _d2.default.time.format('%x %X')(new Date(this.props.startTime)));
    ...
    value: function updateAxes() {
      ...
      chart.select('.header .time').text('Displaying events from ' + _d2.default.time.format('%x %X')(new Date(this.endTime)) + ' to ' + _d2.default.time.format('%x %X')(new Date(this.props.startTime)));
