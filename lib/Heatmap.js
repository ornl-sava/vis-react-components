      ...
      return _react2.default.createElement(
        ...
        props.data.map(function (d, i) {
          ...
          return d.bins.map(function (e, j) {
            ...
            return _react2.default.createElement(_SVGComponent2.default, { Component: 'rect', key: i + '-' + j,
              data: d,
              ...
              onEnter: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attrTween('fill', function () {
                    return (0, _d.interpolate)(_this2.props.minColor, props.fill);
                  });
                  return transition;
                }
              },
              onUpdate: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('x', props.x).attr('y', props.y).attr('width', props.width).attr('height', props.height).attr('fill', props.fill);
                  return transition;
                }
              },
