...
var Heatmap = function (_React$Component) {
  ...
  function Heatmap(props) {
    ...
    _this.colorScale = _d2.default.scale.quantile();
      ...
      if (props.data.length > 0 && props.data[0].bins.length > 0) {
        ...
        if (xDomain.length === 0) {
          ...
          if (props.xScaleType === 'ordinalBand') {
            ...
            xDomain = _d2.default.extent(props.data[0].bins, function (d) {
              return d[props.xAccessor.key];
            });
        ...
        if (yDomain.length === 0) {
          ...
          if (props.yScaleType === 'ordinalBand') {
            ...
            yDomain = [0.000001, _d2.default.max(props.data, function (d) {
              return d[props.yAccessor.key];
            })];
        ...
        var yMax = props.colorPerRow ? _d2.default.max(props.data, function (d, i) {
          return _d2.default.max(d.bins, function (e, j) {
            return e[props.xAccessor.value];
          });
        }) : _d2.default.max(props.data, function (d, i) {
          return d[props.yAccessor.value];
        });

        var tempColorScale = _d2.default.scale.linear().domain([0, yMax]).range([props.minColor, props.maxColor]).interpolate(_d2.default.interpolateHcl);
