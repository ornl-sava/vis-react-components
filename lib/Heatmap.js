    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.data.length > 0) {
        ...
        if (xDomain.length === 0) {
          ...
          var offset = nextProps.data[0].bins[1][nextProps.xKeyField] - nextProps.data[0].bins[0][nextProps.xKeyField];
          if (nextProps.xScaleType === 'ordinalBand') {
            xDomain = nextProps.data[0].bins.map(function (d) {
              return d[nextProps.xKeyField];
            });
          } else {
        ...
        if (yDomain.length === 0) {
          if (nextProps.yScaleType === 'ordinalBand') {
            yDomain = nextProps.data.map(function (d) {
              return d[nextProps.yKeyField];
            });
          } else {
            yDomain = _d2.default.extent(nextProps.data, function (d) {
              return d[nextProps.yKeyField];
            });
          }
        }
        ...
        var yMax = nextProps.colorPerRow ? _d2.default.max(nextProps.data, function (d, i) {
          return _d2.default.max(d.bins, function (e, j) {
            return e[nextProps.xValueField];
          });
        }) : _d2.default.max(nextProps.data, function (d, i) {
          return d[nextProps.yValueField];
        });
        ...
        props.data.map(function (d, i) {
          return d.bins.map(function (e, j) {
            var rectProps = {
              ...
              'fill': _this2.state.colorScale(e[props.xValueField]),
...
Heatmap.propTypes = {
  ...
  xKeyField: _react.PropTypes.string,
  xValueField: _react.PropTypes.string,
  yDomain: _react.PropTypes.array,
  yKeyField: _react.PropTypes.string,
  yValueField: _react.PropTypes.string,
