      ...
      if (Object.keys(props.data).length > 0) {
        ...
        var generateGraph = function generateGraph(data) {
          ...
          if (props.childAccessor in data) {
            data[props.childAccessor].forEach(function (d) {
        ...
        this.radius = (0, _d.min)([props.chartWidth, props.chartHeight]) / this.depth / 2;
        ...
        var maxSize = props.nodeMaxSize !== null ? props.nodeMaxSize : Math.min(graph.nodes.reduce(function (prev, curr) {
        ...
        this.nodeSizeScale.range([props.nodeMinSize, maxSize]).domain((0, _d.extent)(this.graph.nodes, function (d) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.graph.nodes.map(function (d, i) {
            return _react2.default.createElement(_SVGComponent2.default, { ref: 'node-' + i,
...
Circumshaker.propTypes = {
  keyAccessor: _react.PropTypes.string,
  valueAccessor: _react.PropTypes.string,
  childAccessor: _react.PropTypes.string,
