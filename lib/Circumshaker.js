            ...
            return _react2.default.createElement(_SVGComponent2.default, { ref: 'node-' + i,
              ...
              onEnter: {
                func: function func(transition, props) {
                  ...
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attrTween('r', function () {
              ...
              onUpdate: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('r', props.r).attr('cx', props.cx).attr('cy', props.cy);
                  return transition;
                }
              },
              onExit: {
                func: function func(transition, props) {
                  ...
                  x += radius * Math.cos(degree * (Math.PI / 180));
                  y += radius * Math.sin(degree * (Math.PI / 180));
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('r', 0).attr('cx', x).attr('cy', y);
                  return transition;
                }
              },
