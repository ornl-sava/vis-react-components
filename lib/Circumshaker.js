        ...
        _react2.default.createElement(
          ...
          this.graph.nodes.map(function (d, i) {
            return _react2.default.createElement(_SVGComponent2.default, {
              ...
              onEnter: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attrTween('r', function () {
                    ...
                    return (0, _d.interpolate)(0, props.cx);
                  }).attrTween('cy', function () {
                    return (0, _d.interpolate)(0, props.cy);
                  });
                  return transition;
                }
              },
              ...
              onExit: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('r', 0).attr('cx', 0).attr('cy', 0);
                  return transition;
                }
              },
