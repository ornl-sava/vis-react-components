    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (Object.keys(nextProps.data).length > 0) {
        (function () {
          ...
          var generateGraph = function generateGraph(data, depth, parent) {
            // Create node
          ...
          _this2.nodeSizeScale.range([nextProps.nodeMinSize, nextProps.nodeMaxSize]).domain(_d2.default.extent(_this2.graph.nodes, function (d) {
          ...
          graph.nodes.forEach(function (d, i) {
            ...
            d.radius = _this2.nodeSizeScale(graph.links.filter(function (g) {
              return g.source === d || g.target === d;
            }).length);
          });
        })();
