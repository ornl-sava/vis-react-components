...
var Circumshaker = function (_React$Component) {
  ...
  function Circumshaker(props) {
    ...
    _this.depth = 0;
    _this.radius = 0;
    _this.nodeSizeScale = d3.scaleLinear();
  ...
  _createClass(Circumshaker, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (Object.keys(nextProps.data).length > 0) {
        (function () {
          ...
          _this2.depth = Math.min(d3.max(_this2.graph.nodes, function (d) {
            return d.depth;
          }), nextProps.maxDepth);

          // Determine radius
          // NOTE: This is used as more of a radius 'band'
          _this2.radius = d3.min([nextProps.chartWidth, nextProps.chartHeight]) / _this2.depth / 2;
          ...
          _this2.nodeSizeScale.range([nextProps.nodeMinSize, maxSize]).domain(d3.extent(_this2.graph.nodes, function (d) {
    ...
    value: function renderCircumshaker() {
      ...
      return _react2.default.createElement(
        ...
        d3.range(1, this.depth + 1, 1).map(function (d, i) {
