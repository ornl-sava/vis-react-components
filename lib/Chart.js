  ...
  _createClass(Chart, [{
    ...
    value: function setScale(scaleType, range) {
      ...
      if (/ordinal/.test(scaleType)) {
        scale = _d2.default.scale.ordinal();
        ...
        scale = _d2.default.time.scale.utc();
      } else if (scaleType === 'log') {
        scale = _d2.default.scale.log();
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            props.xAxis ? _react2.default.createElement(_Axis2.default, _extends({ className: 'x axis', margin: margin }, props.xAxis, { data: props.data, scale: this.xScale, scaleType: props.xScaleType }, this.state)) : undefined,
            props.yAxis ? _react2.default.createElement(_Axis2.default, _extends({ className: 'y axis', margin: margin }, props.yAxis, { data: props.data, scale: this.yScale, scaleType: props.yScaleType }, this.state)) : undefined,
            props.legend ? _react2.default.createElement(_Legend2.default, { margin: margin, scaleAccessor: props.scaleAccessor, width: this.state.chartWidth, height: this.state.chartHeight, component: this.refs.child }) : undefined
          )
        ),
