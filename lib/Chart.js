...
var Chart = function (_React$Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['width', 'height']);
      ...
      return _react2.default.createElement(
        ...
        this.chartWidth === 0 || this.chartHeight === 0 ? undefined : _react2.default.createElement(_Header2.default, { chart: this, components: this.props.header }),
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'clipPath',
              { id: 'clip' },
              _react2.default.createElement('rect', { width: this.chartWidth, height: this.chartHeight })
            )
          ),
          _react2.default.createElement(
            'g',
            { className: 'vis-container', transform: 'translate(' + left + ',' + top + ')' },
            _react2.default.createElement(
              'g',
              { className: 'vis-component' },
              this.chartWidth === 0 || this.chartHeight === 0 ? undefined : this.renderChildren()
            )
          )
        )
      );
