...
var Chart = function (_React$Component) {
  ...
  function Chart(props) {
    ...
    if (props.addResizeListener) {
      props.addResizeListener(_this.resizeChart.bind(_this));
    }
  ...
  _createClass(Chart, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { ref: this.rootElement, className: props.className, style: { position: 'relative' }, 'data-name': 'chart-root' },
...
Chart.propTypes = {
  ...
  addResizeListener: _propTypes2.default.func,
