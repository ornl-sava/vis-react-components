...
var Chart = function (_React$Component) {
  ...
  function Chart(props) {
    ...
    _this.xScale = _this.setScale(_this.state.xScaleType, [0, _this.state.chartWidth]);
    _this.yScale = _this.setScale(_this.state.yScaleType, [_this.state.chartHeight, 0]);
    return _this;
  }
