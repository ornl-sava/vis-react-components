...
var Chart = function (_React$Component) {
  ...
  _createClass(Chart, [{
    ...
    value: function resizeChart() {
      ...
      var chartWidth = rootRect.width - props.margin.left - props.margin.right;
      var chartHeight = props.height - props.margin.top - props.margin.bottom;
      svg.attr('width', rootRect.width).attr('height', props.height);
      svg.call(this.tip);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            props.legend ? _react2.default.createElement(_Legend2.default, { margin: margin, width: this.state.chartWidth, height: this.state.chartHeight, colorScale: this.refs.child.state.colorScale }) : undefined
          )
        )
      );
    }
