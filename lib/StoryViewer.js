...
var StoryViewer = function (_React$Component) {
  ...
  function StoryViewer(props) {
    ...
    var _this = _possibleConstructorReturn(this, (StoryViewer.__proto__ || Object.getPrototypeOf(StoryViewer)).call(this, props));
  ...
  _createClass(StoryViewer, [{
    ...
    value: function initTopics(props, storyInd) {
      ...
      var moveButt = moveLabels.map(function (label, i) {
        ...
        var bar = _this2.buildABar(data, cName, text, moveBH, moveBW, posX, posY, color, barTxtStyle
        // console.log('bData', bar)
        );bar.tooltipData = { label: cName, counts: 0 };
        return _react2.default.createElement(_TextBar2.default, _extends({ key: 'move' + label }, bar, { onClick: _this2.onMoveClick }));
      });
      ...
      var _loop2 = function _loop2(i) {
        ...
        if (_this3.state.currentID[i] != null) {
          ...
          info = text.map(function (data, index) {
            return _react2.default.createElement(
              'text',
              { key: _this3.tType[i] + 'info-' + index, fontSize: '14px', x: _this3.xScale(0) / 8 + 10, y: startPos + 20 + index * 16 },
              data
            );
          });
        }
        svgInfo[i] = _react2.default.createElement(
          ...
          _react2.default.createElement(
            'text',
            { fontSize: '20px', x: _this3.xScale(0) / 8, y: startPos, style: { fontWeight: 'bold', textDecoration: 'underline' } },
            type
          ),
          info
        );
...
StoryViewer.propTypes = {
  ...
  maxTopics: _propTypes2.default.number.isRequired,
  colorDomain: _propTypes2.default.array,
  lineType: _propTypes2.default.string.isRequired,
  storyData: _propTypes2.default.any,
  hrTopics: _propTypes2.default.any,
  eTopics: _propTypes2.default.any,
