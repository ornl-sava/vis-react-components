      ...
      var _loop2 = function _loop2(i) {
        ...
        if (_this3.state.currentID[i] != null) {
          ...
          info = text.map(function (data, index) {
            return _react2.default.createElement(
              'text',
              { key: _this3.tType[i] + 'info-' + index, fontSize: '14px', x: _this3.props.xScale(3) - _this3.props.xScale(0) / 2 + 10, y: startPos + 20 + index * 16 },
              data
            );
          });
        }
        svgInfo[i] = _react2.default.createElement(
          ...
          _react2.default.createElement(
            'text',
            { fontSize: '20px', x: _this3.props.xScale(3) - _this3.props.xScale(0) / 2, y: startPos, style: { fontWeight: 'bold', textDecoration: 'underline' } },
            type
          ),
          info
        );
