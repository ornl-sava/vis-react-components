    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'text',
          { className: this.props.className + ' text', x: this.props.x + 10 + this.getTxtAlign(), y: this.props.y + this.props.height / 2, style: this.props.textStyle, onMouseEnter: this.onEnter },
          ' ',
          this.props.text,
          ' '
        ),
