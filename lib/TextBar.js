...
var TextBar = function (_React$Component) {
  ...
  _createClass(TextBar, [{
    ...
    value: function makeRect() {
      ...
      var props = _objectWithoutProperties(_props, ['className', 'text', 'width', 'height', 'x', 'y', 'barStyle']);
      ...
      return _extends(rectData, props);
    }
    ...
    value: function render() {
      ...
      var style = _makeRect.style;

      var rProps = _objectWithoutProperties(_makeRect, ['style']);
      // console.log('txtBar')
