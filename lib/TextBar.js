  ...
  _createClass(TextBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Bar2.default, _extends({ className: className + ' barTopic' }, props, { onClick: this.onClick, onDoubleClick: this.onDoubleClick, onEnter: this.onEnter, onLeave: this.onLeave, style: this.props.barStyle }))
      );
    }
  }]);
