...
TextBar.propTypes = {
  ...
  font: _propTypes2.default.number.isRequired,
  barStyle: _propTypes2.default.object,
  textStyle: _propTypes2.default.object,
  textAlign: _propTypes2.default.string.isRequired,
  text: _propTypes2.default.string.isRequired,
  sel: _propTypes2.default.bool.isRequired,
  data: _propTypes2.default.any

  // Only required for REST calls
};TextBar.contextTypes = {
  filterField: _propTypes2.default.string,
  filterString: _propTypes2.default.string,
