...
var ForceDirectedGraph = function (_React$Component) {
  ...
  _createClass(ForceDirectedGraph, [{
    ...
    value: function onEnter(event) {
      ...
      var tooltipD = { label: type + event.target.getAttribute('data-id') + ' at Hour ' + target.data.hour, counts: target.data.events.length };
    ...
    value: function onDragStart(event) {
      ...
      this.simulation.stop();
      var i = this.getDatum(event.target).data.index;
