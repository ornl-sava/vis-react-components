...
var Choropleth = function (_React$Component) {
  ...
  _createClass(Choropleth, [{
    ...
    value: function tooltipData(id) {
      ...
      var index = -1;
      this.props.data[0].bins.forEach(function (d, i) {
      ...
      var datum0 = this.props.data[0].bins[index];
      var datum1 = this.props.data[1].bins[index];
      var counts = typeof datum0 === 'undefined' || typeof datum1 === 'undefined' ? [0, 0] : [datum1[this.props.valueField], datum0[this.props.valueField]];
      var tooltipData = {
        key: id,
        value: counts
      };
    ...
    value: function renderMap() {
      ...
      var tempColorScale = _d2.default.scale.linear().domain([0, this.props.numColorCat]).range([this.props.minColor, this.props.maxColor]).interpolate(_d2.default.interpolateHcl);

      var colorDomain = [0];
      this.props.data[1].bins.forEach(function (d) {
      ...
      var getColor = function getColor(id) {
        ...
        var index = -1;
        _this3.props.data[1].bins.forEach(function (d, i) {
          if (d[_this3.props.keyField] === id) {
            index = i;
            return false;
          }
        });
        var datum = _this3.props.data[1].bins[index];
        var color = _this3.props.minColor;
        if (typeof datum !== 'undefined') {
          color = _this3.state.colorScale(datum[_this3.props.valueField]);
        }
        return color;
      };
