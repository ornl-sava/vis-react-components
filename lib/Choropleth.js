      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _topojson2.default.feature(this.props.map, this.props.map.objects.countries).features.map(function (d, i) {
            return _react2.default.createElement(_SVGComponent2.default, { Component: 'path', key: i,
              ...
              onUpdate: {
                func: function func(transition, props) {
                  transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('fill', props.fill).attr('d', props.d);
                  return transition;
                }
              },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_SVGComponent2.default, { Component: 'path',
            ...
            onUpdate: {
              func: function func(transition, props) {
                transition.delay(0).duration(1000).ease((0, _d2.setEase)('linear')).attr('d', props.d);
                return transition;
              }
            },
            d: this.path(_topojson2.default.mesh(this.props.map, this.props.map.objects.countries, function (a, b) {
              return a !== b;
            })) })
        )
      );
