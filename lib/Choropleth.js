...
var Choropleth = function (_React$Component) {
  ...
  function Choropleth(props) {
    ...
    _this.selectedColorScale = (0, _d.scaleQuantile)();
    _this.unselectedColorScale = (0, _d.scaleQuantile)();
  ...
  _createClass(Choropleth, [{
    ...
    value: function renderMap() {
      ...
      var tempSelectedColorScale = (0, _d.scaleLinear)().domain([0, this.props.numColorCat]).range([this.props.selectedMinColor, this.props.selectedMaxColor]).interpolate(_d.interpolateHcl);

      var tempUnselectedColorScale = (0, _d.scaleLinear)().domain([0, this.props.numColorCat]).range([this.props.unselectedMinColor, this.props.unselectedMaxColor]).interpolate(_d.interpolateHcl);
      ...
      (0, _d.range)(this.props.numColorCat).map(function (i) {
