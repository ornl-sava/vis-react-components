    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'text',
          { x: 0, y: 14 },
          _d2.default.format('n')(Math.round(colorScale.domain()[0]))
        ),
        _react2.default.createElement(
          'text',
          { x: colorScale.range().length * legendBlockWidth, y: 15, textAnchor: 'end' },
          _d2.default.format('n')(Math.round(colorScale.domain()[colorScale.domain().length - 1]))
        )
      );
    }
  }]);
...
Legend.defaultProps = {
  colorScale: _d2.default.scale.linear(),
