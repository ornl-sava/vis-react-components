...
var BrushX = function (_React$Component) {
  ...
  _createClass(BrushX, [{
    ...
    key: 'resizePath',
    value: function resizePath(d) {
      var e = +(d === 'e');
      var x = e ? 1 : -1;
      var y = handleHeight / 3;
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (this.props.width !== prevProps.width || this.props.height !== prevProps.height) {
        ...
        this.brush = (0, _d.brushX)().extent([[0, 0], [this.props.width, this.props.height]]).on('brush', this._brush.bind(this)).on('end', this._end.bind(this));
        selection.call(this.brush);
        handleHeight = this.props.height;
        selection = (0, _d.select)(thisNode).selectAll('.handle').append('path').attr('d', this.resizePath);
        // console.log(handles)
      }
    }
  }, {
