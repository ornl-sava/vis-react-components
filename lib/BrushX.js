...
var BrushX = function (_React$Component) {
  ...
  function BrushX(props) {
    ...
    _this.selection = props.brushSelection ? props.brushSelection : [];
  ...
  _createClass(BrushX, [{
    ...
    key: '_end',
    value: function _end() {
      var newSelection = this.selection.toString();
      var oldSelection = this.props.brushSelection ? this.props.brushSelection.toString() : this.state.selection.toString();
