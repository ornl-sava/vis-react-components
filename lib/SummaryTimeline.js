...
var SummaryTimeline = function (_React$Component) {
  ...
  _createClass(SummaryTimeline, [{
    ...
    value: function render() {
      ...
      var stdevMinLine = d3.line().x(function (d) {
        return x(d.date);
      }).y(function (d) {
        return y(d.stdevMin);
      })(data);
      var stdevMaxLine = d3.line().x(function (d) {
        return x(d.date);
      }).y(function (d) {
        return y(d.stdevMax);
      })(data);
      ...
      var stdevRangeArea = d3.area().x(function (d) {
        return x(d.date);
      }).y0(function (d) {
        return y(d.stdevMin);
      }).y1(function (d) {
      ...
      var extentRangeArea = d3.area().x(function (d) {
        return x(d.date);
      }).y0(function (d) {
        return y(d.min);
      }).y1(function (d) {
