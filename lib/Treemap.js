  ...
  _createClass(Treemap, [{
    ...
    value: function render() {
      ...
      var getParent = function getParent(id, zoomOut) {
        if (_this2.props.zoom && _this2.state.selectedId === id && !zoomOut) {
          return '';
        }
      ...
      if (this.props.zoom && this.state.selectedId) {
        ...
        this.props.data.map(function (d) {
          if (d.id === _this2.state.selectedId || d.id.includes(_this2.state.selectedId + '.')) {
            activeData.push(d);
          }
          if (d.id === _this2.state.selectedId) {
            stillThere = true;
          }
        });
      ...
      return _react2.default.createElement(
        ...
        this.props.zoom && _react2.default.createElement(_SVGComponent2.default, { Component: 'rect',
          ...
          onClick: function onClick() {
            if (_this2.state.selectedId) {
              _this2.setState({ selectedId: getParent(_this2.state.selectedId, true) });
            }
          },
