...
var SVGComponent = function (_React$Component) {
  ...
  _createClass(SVGComponent, [{
    ...
    value: function animate(callback, props, type) {
      ...
      var propsCopy = JSON.parse(JSON.stringify((0, _react3.spreadExclude)(props, { children: '' })));
      node.transition(this.transition).call(function (transition) {
