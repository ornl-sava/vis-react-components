...
var HorizonGraphChart = function (_React$Component) {
  ...
  _createClass(HorizonGraphChart, [{
    ...
    value: function updateRange() {
      ...
      if (this.props.yAxis.innerPadding && (0, _d2.isOrdinalScale)(this.yScale.type)) {
        this.yScale.paddingInner(this.props.yAxis.innerPadding);
      }

      if (this.props.yAxis.outerPadding && (0, _d2.isOrdinalScale)(this.yScale.type)) {
        this.yScale.paddingOuter(this.props.yAxis.outerPadding);
      }

      this.xScale.range([0, this.refs.chart.chartWidth]);
      if (this.props.xAxis.innerPadding && (0, _d2.isOrdinalScale)(this.xScale.type)) {
        this.xScale.paddingInner(this.props.xAxis.innerPadding);
      }

      if (this.props.xAxis.outerPadding && (0, _d2.isOrdinalScale)(this.xScale.type)) {
    ...
    value: function onResize() {
      (0, _lodash2.default)(this.updateRange.bind(this), 500, { trailing: true });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_HorizonGraph2.default, _extends({ className: 'horizonGraph'
        }, (0, _react3.spreadRelated)(_HorizonGraph2.default, props))),
...
HorizonGraphChart.propTypes = _extends({}, _HorizonGraph2.default.propTypes, _Chart2.default.propTypes, {
  brushID: _propTypes2.default.any,
