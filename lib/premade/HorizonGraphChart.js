...
var HorizonGraphChart = function (_React$Component) {
  ...
  function HorizonGraphChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HorizonGraphChart).call(this, props));
  ...
  _createClass(HorizonGraphChart, [{
    ...
    value: function updateDomain(props, state) {
      ...
      if (props.data.length > 0) {
        (function () {
          var xDomain = _this2.xDomain;
          if (xDomain.length === 0) {
            if (_this2.xScale.type === 'band') {
          ...
          var yDomain = _this2.yDomain;
          if (yDomain.length === 0) {
            if (_this2.yScale.type === 'band') {
              ...
              var height = Math.max(Math.abs(args[0]), Math.abs(args[1])) / props.numBands;
              yDomain = [mid, mid + height];
            }
          }

          _this2.xScale.domain(xDomain);
          _this2.yScale.domain(yDomain);
        })();
      }
    }
  }, {
