  ...
  _createClass(HistogramChart, [{
    ...
    value: function sortData(data, props, state) {
      ...
      data[0].bins.sort(function (a, b) {
        var i = 0;
        if (props.sortBy === 'x') {
          i = props.sortOrder === 'ascending' || props.sortOrder === 'asc' ? (0, _d.ascending)(a[props.xAccessor], b[props.xAccessor]) : (0, _d.descending)(a[props.xAccessor], b[props.xAccessor]);
        } else {
