...
var HistogramChart = function (_React$Component) {
  ...
  function HistogramChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HistogramChart).call(this, props));
  ...
  _createClass(HistogramChart, [{
    ...
    value: function sortData(data, props, state) {
      ...
      data[0].bins.sort(function (a, b) {
        var i = 0;
        if (props.sortBy === 'x') {
          i = props.sortOrder === 'ascending' ? (0, _d.ascending)(a[props.xAccessor], b[props.xAccessor]) : (0, _d.descending)(a[props.xAccessor], b[props.xAccessor]);
        } else {
