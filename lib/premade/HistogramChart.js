    ...
    value: function sortData(data, props, state) {
      ...
      data[0].bins.sort(function (a, b) {
        ...
        if (props.sortBy === 'x' || props.sortBy == null) {
          i = props.sortOrder === 'ascending' || props.sortOrder == null ? (0, _d.ascending)(a[props.xAccessor], b[props.xAccessor]) : (0, _d.descending)(a[props.xAccessor], b[props.xAccessor]);
        } else {
