  ...
  _createClass(ScatterplotChart, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Scatterplot2.default, _extends({ className: 'scatterplot' }, (0, _react3.spreadRelated)(_Scatterplot2.default, props), {
...
ScatterplotChart.defaultProps = _extends({
  // Premade default
  data: [],
  xDomain: [],
  yDomain: []
}, _Chart2.default.defaultProps, _Scatterplot2.default.defaultProps, {
  xAxis: {
    type: 'x',
    orient: 'bottom',
    innerPadding: null,
...
ScatterplotChart.propTypes = _extends({}, _Scatterplot2.default.propTypes, _Chart2.default.propTypes, {
