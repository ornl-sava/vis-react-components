...
var ChoroplethChart = function (_React$Component) {
  ...
  function ChoroplethChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ChoroplethChart.__proto__ || Object.getPrototypeOf(ChoroplethChart)).call(this, props));
...
ChoroplethChart.propTypes = _extends({
  selectedMinColor: _propTypes2.default.string,
  selectedMaxColor: _propTypes2.default.string,
  unselectedMinColor: _propTypes2.default.string,
  unselectedMaxColor: _propTypes2.default.string,
  numColorCat: _propTypes2.default.number
}, _Choropleth2.default.propTypes, _Chart2.default.propTypes, {
