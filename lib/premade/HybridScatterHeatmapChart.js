...
var HybridScatterHeatmapChart = function (_React$Component) {
  ...
  function HybridScatterHeatmapChart(props) {
    ...
    _this.scatterDataMap = (0, _d.map)();
    _this.scatterDataArray = [];
    _this.scatterKey = function (d, i) {
      var key = d[props.scatterXAccessor] + '-' + d[props.scatterYAccessor];
      return key;
    };
  ...
  _createClass(HybridScatterHeatmapChart, [{
    ...
    value: function generateColorScale(props, state) {
      var yMax = (0, _d.max)(props.data, function (d, i) {
        return (0, _d.max)(d.bins, function (e, j) {
          return e[props.heatmapXAccessor.value];
        });
      });
    ...
    value: function onColumnMarkerClick(event, data, index) {
      var i = this.state.expandedSectionNumbers.indexOf(index);
      var toExpand = null;
      if (i > -1) {
    ...
    value: function onHeatmapClick(event, data, index) {
      ...
      if (this.scatterDataMap.has(index)) {
        this.scatterDataMap.remove(index);
      } else {
        this.scatterDataMap.set(index, data.data);
      }

      this.scatterDataArray = [];
      this.scatterDataMap.each(function (v, k) {
        for (var i = 0; i < v.length; i++) {
          _this2.scatterDataArray.push(v[i]);
        }
      });
    ...
    value: function render() {
      ...
      // Get scatter data
      // TODO: Key FUnction for scatterplot
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Heatmap2.default, { className: 'heatmap', data: data,
        ...
        _react2.default.createElement(_Scatterplot2.default, { className: 'scatter', data: this.scatterDataArray,
