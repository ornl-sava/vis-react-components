...
var HybridScatterHeatmapChart = function (_React$Component) {
  ...
  _createClass(HybridScatterHeatmapChart, [{
    ...
    value: function onHeatmapClick(event, data, index) {
      ...
      var scatterData = [];
      this.scatterMap.each(function (v, k) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Scatterplot2.default, { ref: 'scatter', className: 'scatter', data: this.state.scatterData, keyFunction: this.scatterKey,
