...
var HybridScatterHeatmapChart = function (_React$Component) {
  ...
  _createClass(HybridScatterHeatmapChart, [{
    ...
    value: function generateColorScale(props, state) {
      ...
      );var tempColorScale = (0, _d2.setScale)('linear').domain([0, props.heatmapNumColorCat]).range([props.heatmapMinColor, props.heatmapMaxColor]).interpolate(_d.interpolateHcl);var colorRange = [];
...
HybridScatterHeatmapChart.defaultProps = _extends({
  ...
  timeWindow: _propTypes2.default.number.isRequired,
  scatterMinColor: _propTypes2.default.string,
  scatterMaxColor: _propTypes2.default.string,
  heatmapMinColor: _propTypes2.default.string,
  heatmapMaxColor: _propTypes2.default.string,
  heatmapNumColorCat: _propTypes2.default.number
