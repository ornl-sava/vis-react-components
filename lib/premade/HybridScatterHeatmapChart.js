...
var HybridScatterHeatmapChart = function (_React$Component) {
  ...
  _createClass(HybridScatterHeatmapChart, [{
    ...
    key: 'onHeatmapClick',
    value: function onHeatmapClick(event, data) {
      this.props.onHeatmapClick(event, data);
    }
  }, {
    key: 'onHeatmapEnter',
    value: function onHeatmapEnter(event, data) {
      if (data && this.tip) {
    ...
    key: 'onHeatmapLeave',
    value: function onHeatmapLeave(event, data) {
      if (data && this.tip) {
    ...
    value: function onScatterplotClick(event, data) {
      this.props.onScatterplotClick(event, data);
    }
  }, {
    key: 'onScatterplotEnter',
    value: function onScatterplotEnter(event, data) {
      if (data && this.tip) {
        this.tip.show(event, data);
      }
    ...
    value: function onScatterplotLeave(event, data) {
      if (data && this.tip) {
        this.tip.hide(event, data);
      }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Scatterplot2.default, _extends({ className: 'scatter' }, (0, _react3.spreadRelated)(_Scatterplot2.default, props), {
...
HybridScatterHeatmapChart.defaultProps = _extends({
  ...
  xDomain: [],
  yDomain: []
}, _Chart2.default.defaultProps, _Heatmap2.default.defaultProps, _Scatterplot2.default.defaultProps, {
  xAxis: {
    type: 'x',
    orient: 'bottom',
    innerPadding: null,
...
HybridScatterHeatmapChart.propTypes = _extends({}, _Heatmap2.default.propTypes, _Scatterplot2.default.propTypes, _Chart2.default.propTypes, {
