...
var HeatmapChart = function (_React$Component) {
  ...
  function HeatmapChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, (HeatmapChart.__proto__ || Object.getPrototypeOf(HeatmapChart)).call(this, props));
...
HeatmapChart.propTypes = _extends({
  minColor: _propTypes2.default.string,
  maxColor: _propTypes2.default.string,
