...
var TopicsChart = function (_React$Component) {
  ...
  function TopicsChart(props) {
    ...
    var _this = _possibleConstructorReturn(this, (TopicsChart.__proto__ || Object.getPrototypeOf(TopicsChart)).call(this, props));
...
TopicsChart.propTypes = _extends({
  numTData: _propTypes2.default.number,
  maxTopics: _propTypes2.default.number,
  url: _propTypes2.default.string,
  colorDomain: _propTypes2.default.array,
  tipFunction: _propTypes2.default.func,
  data: _propTypes2.default.array,
  topicBins: _propTypes2.default.array,
  sortAccessor: _propTypes2.default.string,
