...
var Settings = function (_React$Component) {
  ...
  function Settings(props) {
    ...
    _this3.onChange = _this3._onChange.bind(_this3);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          settings.options.map(function (d, i) {
            ...
            if (d.type === 'dropdown') {
              return _react2.default.createElement(Dropdown, _extends({ key: i, chart: chart }, rest, { onChange: function onChange(val, chart) {
                  return _this4.onChange(val, _onChange2, chart);
                } }));
            }
            if (d.type === 'input') {
              return _react2.default.createElement(Input, _extends({ key: i, chart: chart }, rest, { onChange: function onChange(val) {
