  ...
  _createClass(Histogram, [{
    ...
    value: function sortData(data, props, state) {
      ...
      data[0].bins.sort(function (a, b) {
        var i = 0;
        if (props.sortBy === 'x') {
          i = props.sortOrder === 'ascending' ? d3.ascending(a[props.xAccessor], b[props.xAccessor]) : d3.descending(a[props.xAccessor], b[props.xAccessor]);
        } else {
    ...
    value: function renderHistogram() {
      ...
      var barWidth = props.xScale.type === 'ordinalBand' ? props.xScale.bandwidth() : chartWidth / numBins;
