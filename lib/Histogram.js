          ...
          return _react2.default.createElement(_SVGComponent2.default, _extends({ Component: 'rect' }, data, {
            ...
            onUpdate: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attr('height', props.height).attr('width', props.width).attr('y', props.y);
                return transition;
              }
            } }));
        });
      ...
      var svgBins = svgBars.map(function (bars, i) {
        ...
        return _react2.default.createElement(
          _SVGComponent2.default,
          {
            ...
            onUpdate: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attr('transform', 'translate(' + xPos + ',' + yPos + ')');
                return transition;
              }
            } },
          bars
