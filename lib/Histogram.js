...
var Histogram = function (_React$Component) {
  ...
  _createClass(Histogram, [{
    ...
    key: '_onMouseDown',
    value: function _onMouseDown(event, data, index) {
      if (data) {
    ...
    value: function getOverlay(barData) {
      ...
      var overlayBins = overlayData.map(function (overlayObj, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_Bar2.default, _extends({}, overlayObj, { onClick: _this2.props.brushed ? null : props.onClick, onEnter: props.onEnter, onLeave: props.onLeave }))
        );
      });
    ...
    value: function renderBars() {
      ...
      var barData = transpose(props.data.map(function (histogram, index) {
        return histogram.bins.map(function (bin) {
          ...
          return _this3.buildABar(bin, props.data[index].name, props.data[index].type, barHeight, barWidth, yPos);
        });
      }));
      var overlayBins = [];
      ...
      var svgBars = barData.map(function (dataArr, index) {
        return dataArr.map(function (data, barIndex) {
          ...
          return _react2.default.createElement(_SVGComponent2.default, _extends({ Component: 'rect' }, data, {
            ...
            onEnter: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attrTween('height', function () {
                  return (0, _d.interpolate)(0, props.height);
                }).attrTween('width', function () {
                  return (0, _d.interpolate)(props.width, props.width);
                }).attr('x', function () {
                  return (0, _d.interpolate)(0, props.x);
                }).attrTween('y', function () {
                  return (0, _d.interpolate)(0, props.y);
                });
                return transition;
              }
            },
            onUpdate: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attr('height', props.height).attrTween('width', function () {
                  return (0, _d.interpolate)(props.width, props.width);
            ...
            onExit: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attr('width', props.width).attr('height', 0).attr('x', props.x).attr('y', props.y);
              }
            } }));
        });
      });
      ...
      if (barData.length > 1 && props.brushed) {
        ...
        el = _react2.default.createElement(
          ...
          _react2.default.createElement(
            _BrushX2.default,
            { width: props.xScale.range()[1], height: props.yScale.range()[0], interval: interval, scale: props.xScale, onBrush: props.onBrush },
            _react2.default.createElement(
              _reactAddonsTransitionGroup2.default,
              { component: 'g' },
              svgBins
