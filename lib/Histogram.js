    ...
    value: function getOverlay(barData) {
      ...
      var overlayBins = overlayData.map(function (overlayObj, i) {
        ...
        return _react2.default.createElement(
          'g',
          { className: 'overlay-bin', key: 'overlay-' + i },
          ...
          return _react2.default.createElement(_SVGComponent2.default, _extends({ Component: 'rect' }, data, {
            ...
            onUpdate: {
              func: function func(transition, props) {
                transition.delay(0).duration(750).ease((0, _d2.setEase)('linear')).attr('height', props.height).attr('width', props.width).attr('y', props.y).attr('x', props.x);
                return transition;
              }
            } }));
        });
