...
var Histogram = function (_React$Component) {
  ...
  function Histogram(props) {
    ...
    = _possibleConstructorReturn(this, (Histogram.__proto__ || Object.getPrototypeOf(Histogram)).call(this, props));

    _this.onMouseLeave = _this._onMouseLeave.bind(_this);
    _this.onMouseEnter = _this._onMouseEnter.bind(_this);_this.renderBars = _this.renderBars.bind(_this);
    return _this;
  }
  ...
  _createClass(Histogram, [{
    ...
    value: function getOverlay(barData) {
      ...
      var overlayBins = overlayData.map(function (overlayObj, i) {
        ...
        return _react2.default.createElement(
          'g',
          { className: 'overlay-bin', key: overlayObj.name + '-overlay-' + i },
    ...
    value: function renderBars() {
      ...
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['chartWidth', 'chartHeight']);
...
Histogram.defaultProps = {
  ...
  addOverlay: _propTypes2.default.bool,
