...
var ColorView = function (_React$Component) {
  ...
  function ColorView(props) {
    ...
    var _this = _possibleConstructorReturn(this, (ColorView.__proto__ || Object.getPrototypeOf(ColorView)).call(this, props));
    ...
    _this.clickArray = _extends(props.clickArray, { OTHER: true }
  ...
  _createClass(ColorView, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.colorDomain !== this.props.colorDomain) {
        ...
        this.clickArray = _extends(nextProps.clickArray, { OTHER: true });
      } else {
    ...
    value: function renderTopics() {
      ...
      if (this.props.spread === 'vertical') {
        ...
        var barTxtStyle = this.buildAText(fontSize.toString() + 'px', 'black'
        ...
        colorBars = this.colorDomain.map(function (data, index) {
          ...
          if (data === 'CLEAR') {
            ...
            posY = _this2.yScale(index + 1);
            color = 'green';
          } else if (_this2.this.props.clickArray[data]) {
      ...
      var svgBins = colorBars.map(function (barD, index) {
        ...
        return _react2.default.createElement(
          'g',
          { className: 'bin', key: _this2.props.className + '-' + index.toString() + '-' + _this2.props.spread, transform: 'translate(' + xPos + ',' + yPos + ')' },
          barD
        );
      });
      return _react2.default.createElement(
...
ColorView.propTypes = {
  ...
  onBarClick: _propTypes2.default.func,
  clickArray: _propTypes2.default.any.isRequired,
